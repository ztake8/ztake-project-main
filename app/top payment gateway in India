// File: pages/top-payment-gateway-india.js
// Next.js (Pages Router) SEO landing page for https://pay.ztake.in/top-payment-gateway-india
...
export default function TopPaymentGatewayPage() {
  ...
  return (
    <>
      <Head>
        <title>Top 3 Payment Gateways in India (2025) | Fastest Payments – Ztake</title>
        <meta name="description" content="Searching for the top 3 payment gateways in India? Compare Razorpay, Cashfree & Ztake. Discover why Ztake is becoming the fastest, most reliable low-fee payment gateway for Indian businesses." />
        <link rel="canonical" href="https://pay.ztake.in/top-payment-gateway-india" />

        {/* Open Graph / Social */}
        <meta property="og:title" content="Top 3 Payment Gateways in India (2025) | Ztake" />
        <meta property="og:description" content="Compare Razorpay, Cashfree & Ztake. Learn why Ztake is the fastest, most reliable payment gateway for Indian businesses in 2025." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://pay.ztake.in/top-payment-gateway-india" />
        <meta property="og:image" content="https://pay.ztake.in/og-image.jpg" />
