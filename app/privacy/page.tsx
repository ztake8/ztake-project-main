    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 pt-32 overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          ...
          <div className="absolute bottom-0 left-0 w-80 h-80 bg-primary/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>

        <div className="max-w-5xl mx-auto relative z-10">
          <div className="animate-fadeInUp">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 text-foreground text-balance">Privacy Policy</h1>
            <p className="text-xl text-muted-foreground mb-2">Last Updated: 21/11/2024</p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <GlassCard className="p-8 md:p-12 animate-fadeIn">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-8">
          {sections.map((section, index) => (
            <div key={section.id} className="animate-fadeInUp" style={{ animationDelay: `${index * 100}ms` }}>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <GlassCard className="p-8 md:p-12 bg-gradient-to-br from-primary/10 via-transparent to-primary/5 dark:from-primary/5 dark:via-transparent dark:to-primary/5 animate-scaleIn">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-4 rounded-lg bg-white/30 dark:bg-white/5 border border-white/20 dark:border-white/10">
