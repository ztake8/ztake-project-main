        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-16 animate-fadeInUp">
            ...
            <p className="text-lg text-muted-foreground mb-4">
              This Refund & Cancellation Policy is issued by Ztake Fintech Private Limited and governs the rules, processes, responsibilities, and terms related to refunds, cancellations, reversals, and disputes for all transactions processed through Ztake's payment infrastructure.
            </p>
