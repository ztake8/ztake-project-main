...
export default function Page() {
  const title = "International Payment Gateway India | Ztake";
  const description = "International Payment Gateway India – Accept multi-currency, global cards, and get fast forex settlements.";
  const canonical = "https://pay.ztake.in/international-payment-gateway-india";
  const ogImage = "/api/og?title=International+Payment+Gateway+India+%7C+Ztake";
...
International Payment Gateway India – Accept multi-currency, global cards, and get fast forex settlements.
