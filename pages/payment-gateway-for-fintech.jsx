...
export default function Page() {
  const title = "Payment Gateway for Fintech | Ztake";
  const description = "Payment Gateway for Fintech – Fintech needs API-first, KYC-aware flows, secure webhooks, and predictable settlement behavior.";
  const canonical = "https://pay.ztake.in/payment-gateway-for-fintech";
  const ogImage = "/api/og?title=Payment+Gateway+for+Fintech+%7C+Ztake";
...
Payment Gateway for Fintech – Fintech needs API-first, KYC-aware flows, secure webhooks, and predictable settlement behavior.
