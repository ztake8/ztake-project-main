...
export default function Page() {
  const title = "Payment Gateway for Marketplaces | Ztake";
  const description = "Payment Gateway for Marketplaces – Split payments, escrow, seller onboarding and instant settlements are crucial for marketplaces.";
  const canonical = "https://pay.ztake.in/payment-gateway-for-marketplaces";
  const ogImage = "/api/og?title=Payment+Gateway+for+Marketplaces+%7C+Ztake";
...
Payment Gateway for Marketplaces – Split payments, escrow, seller onboarding and instant settlements are crucial for marketplaces.
