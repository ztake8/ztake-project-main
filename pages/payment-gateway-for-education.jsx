...
export default function Page() {
  const title = "Payment Gateway for Education | Ztake";
  const description = "Payment Gateway for Education – Recurring fees, EMI options, and automated reconciliation help schools, colleges and EdTech.";
  const canonical = "https://pay.ztake.in/payment-gateway-for-education";
  const ogImage = "/api/og?title=Payment+Gateway+for+Education+%7C+Ztake";
  ...
  return (
    <>
      ...
      <main style={{maxWidth:960,margin:'40px auto',fontFamily:'system-ui'}}>
        <article>
# Payment Gateway for Education

Payment Gateway for Education – Recurring fees, EMI options, and automated reconciliation help schools, colleges and EdTech.
