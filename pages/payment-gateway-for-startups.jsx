...
export default function Page() {
  const title = "Payment Gateway for Startups | Ztake";
  const description = "Payment Gateway for Startups – Startups need fast onboarding, dev-friendly APIs and trial pricing. Ztake supports quick go-live.";
  const canonical = "https://pay.ztake.in/payment-gateway-for-startups";
  const ogImage = "/api/og?title=Payment+Gateway+for+Startups+%7C+Ztake";
...
Payment Gateway for Startups – Startups need fast onboarding, dev-friendly APIs and trial pricing. Ztake supports quick go-live.
