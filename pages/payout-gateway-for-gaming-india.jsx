...
export default function Page() {
  const title = "Payout Gateway for Gaming | Ztake";
  const description = "Payout Gateway for Gaming – Gaming payouts must be instant, reliable, and reconciled. Ztake supports automated payouts.";
  const canonical = "https://pay.ztake.in/payout-gateway-for-gaming-india";
  const ogImage = "/api/og?title=Payout+Gateway+for+Gaming+%7C+Ztake";
  ...
  return (
    <>
      ...
      <main style={{maxWidth:960,margin:'40px auto',fontFamily:'system-ui'}}>
        <article>
# Payout Gateway for Gaming

Payout Gateway for Gaming – Gaming payouts must be instant, reliable, and reconciled. Ztake supports automated payouts.
