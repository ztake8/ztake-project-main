...
export default function Page() {
  const title = "Payment Gateway for Gaming | Ztake";
  const description = "Payment Gateway for Gaming – Gaming needs microtransactions, instant deposits, anti-fraud tuned to player behavior, and instant withdrawals.";
  const canonical = "https://pay.ztake.in/payment-gateway-for-gaming";
  const ogImage = "/api/og?title=Payment+Gateway+for+Gaming+%7C+Ztake";
...
Payment Gateway for Gaming – Gaming needs microtransactions, instant deposits, anti-fraud tuned to player behavior, and instant withdrawals.
