...
export default function Page() {
  const title = "Instant Settlement Payment Gateway | Ztake";
  const description = "Instant Settlement Payment Gateway – Cash flow matters. Instant or same-day settlements reduce operational friction.";
  const canonical = "https://pay.ztake.in/instant-settlement-payment-gateway";
  const ogImage = "/api/og?title=Instant+Settlement+Payment+Gateway+%7C+Ztake";
...
Instant Settlement Payment Gateway – Cash flow matters. Instant or same-day settlements reduce operational friction.
